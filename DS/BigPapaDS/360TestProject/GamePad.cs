...
namespace Gamepadtest
{
    public class GamepadState
    {
        ...
        private bool a, b, x, y, rightShoulder, leftShoulder, start, back;
        private float rightTrigger;
        private float leftTrigger;

        public bool Connected
        {
            get { try { return Controller.IsConnected; }
                catch { return false; }
            }
        }
        ...
        public event EventHandler<ControllerChangedArgs> ControllerValueChanged;
