...
TankDrive::TankDrive(PCA9685* PWM, int leftPin1, int leftPin2, int leftPin3, int rightPin1, int rightPin2, int rightPin3) : controller(PWM)
{
    _leftPin1 = leftPin1;
    _leftPin2 = leftPin2;
    _leftPin3 = leftPin3;
