...
public:
    ...
    unsigned char updateBowlingBallIntake(unsigned char intakeIn, unsigned char intakeOut, unsigned char rotateIn, unsigned char rotateOut, unsigned char liftUp, unsigned char liftDown);
    void failsafe();
private:
    PCA9685* controller;
